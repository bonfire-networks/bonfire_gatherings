...
- Rename all the modules names to match your extension name:
    - Find & replace Bonfire.Gatherings -> Bonfire.YourExtensionName 
    - Find & replace bonfire_gatherings -> bonfire_your_extension_name
- Rename the `bonfire_gatherings.exs` config file to match your extension name `bonfire_your_extension_name.exs`
...
- Add `use_if_enabled(Bonfire.Gatherings.Web.Routes)` in your app's `Router` module
